 ...
 * 3: twist
 * 4: throttle
 * 5: POV hat left/right
 * 6: POV hat up/down */

static const uint32_t Axis_RightDrive = 2;
static const uint32_t Axis_LeftDrive = 2;
...
//static const uint32_t Button_ShooterLock = 1;
...
static const uint32_t Button_LimPullIn = 4;
static const uint32_t Button_LimPass = 6;
static const uint32_t Button_SwitchPull = 4;
